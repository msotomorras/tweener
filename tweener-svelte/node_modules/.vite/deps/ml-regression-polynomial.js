...
// node_modules/ml-regression-base/lib-esm/BaseRegression.js
init_lib_esm();

// node_modules/ml-regression-base/lib-esm/checkArrayLength.js
init_lib_esm();
...
// node_modules/ml-regression-base/lib-esm/maybeToPrecision.js
...
// node_modules/ml-regression-polynomial/lib-esm/index.js
var PolynomialRegression = class _PolynomialRegression extends BaseRegression {
  /**
...
function regress(x, y, degree, options = {}) {
  ...
  const F = new Matrix2(n, nCoefficients);
  const Y = new Matrix2([y]);
  ...
  const FT = new MatrixTransposeView2(F);
  const A = FT.mmul(F);
  const B = FT.mmul(new MatrixTransposeView2(Y));
  return {
    coefficients: solve2(A, B).to1DArray(),
...
//# sourceMappingURL=ml-regression-polynomial.js.map
